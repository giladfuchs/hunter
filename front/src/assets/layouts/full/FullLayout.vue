...
watch(error_message_change,  () => {
  if(error_message_change.value)
  error_snackbar.value=true
});
...
<template>
  <v-locale-provider>
    ...
    >
      ...
      <v-main>
        <v-progress-linear v-if="customizer.loading" style="z-index: 124;   top: 4.9rem; height: .4rem;
  width: 100%; position: fixed;" color="primary" indeterminate></v-progress-linear>
